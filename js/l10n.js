...
$.L10n._strings.de = {
	'click-to-continue': 'Klicken zum weiterlesen',
	'tutorial-1-message': 'Swipe in eine Richtung zu würfeln',
	'tutorial-2-message': 'Langes Drücken auf eine Düse, um sie zu entfernen',
	'tutorial-3-message': 'Öffnen Sie Einstellungen, um Würfel Zahl gesetzt, oder schauen Sie das Tutorial wieder',
	'done': 'fertig',
	'settings-dicenumber-header': 'Würfel Nummer',
	'settings-tutorial-header': 'Tutorial',
	'settings-watch-tutorial': 'Sehen Sie das Tutorial'
};

$.L10n._strings.en = {
	'click-to-continue': 'Click to continue',
	'tutorial-1-message': 'Swipe in one direction to roll dice',
	'tutorial-2-message': 'Long press on a die to remove it',
	'tutorial-3-message': 'Open settings to set dice number or watch this tutorial again',
	'done': 'done',
	'settings-dicenumber-header': 'Dice number',
	'settings-tutorial-header': 'Tutorial',
...
$.L10n._strings.it = {
	...
	'tutorial-2-message': 'Long press su un dado per rimuoverlo',
	'tutorial-3-message': 'Apri le impostazioni per cambiare il numero di dadi o rivedere il tutorial',
	'done': 'fatto',
